...
namespace ProjectContosoUniversity.Pages.Instructors
{
    public class EditModel : InstructorCoursesPageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(int? id)
        {
            ...
            Instructor = await _context.Instructors.Include(i => i.OfficeAssignment).Include(i => i.Courses).AsNoTracking().FirstOrDefaultAsync(m => m.ID == id);
        ...
        public async Task<IActionResult> OnPostAsync(int? id, string[] selectedCourses)
        {
            ...
            var instructorToUpdate = await _context.Instructors.Include(i => i.OfficeAssignment).Include(i => i.Courses).FirstOrDefaultAsync(s => s.ID == id);
