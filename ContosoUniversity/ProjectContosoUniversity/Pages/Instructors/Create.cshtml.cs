...
namespace ProjectContosoUniversity.Pages.Instructors
{
    public class CreateModel : InstructorCoursesPageModel
    {
        ...
        public CreateModel(StudentContext context, ILogger<InstructorCoursesPageModel> logger)
        {
            _context = context;
            _logger = logger;
        }
        ...
        public IActionResult OnGet()
        {
            ...
            // Provides an empty collection for the 'foreach' loop 'foreach(var course in Model.AssignedCourseDataList)' in the Create Razor page.
